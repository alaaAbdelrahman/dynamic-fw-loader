...
/**
  ...
  * @param  GPIOx: (uint32_t *)GPIOA~(uint32_t *)GPIOF
  ...
  * @retval None
  */
void GPIO_Init(uint32_t *GPIOx, GPIO_InitType *InitStruct)
{
  if (GPIOx == (uint32_t *)GPIOA)
  {
    GPIOA_Init((GPIOA_TypeDef *)GPIOx, InitStruct);
  }
  else
  {
    GPIOBToF_Init((GPIO_TypeDef *)GPIOx, InitStruct);
  }
}
...
uint8_t GPIO_ReadInputDataBit(uint32_t *GPIOx, uint16_t GPIO_Pin)
{
  if (GPIOx == (uint32_t *)GPIOA)
  {
    return GPIOA_ReadInputDataBit((GPIOA_TypeDef *)GPIOx, GPIO_Pin);
  }
  else
  {
    return GPIOBToF_ReadInputDataBit((GPIO_TypeDef *)GPIOx, GPIO_Pin);
  }
}
...
uint16_t GPIO_ReadInputData(uint32_t* GPIOx)
{
  if (GPIOx == (uint32_t *)GPIOA)
  {
    return GPIOA_ReadInputData((GPIOA_TypeDef *)GPIOx);
  }
  else
  {
    return GPIOBToF_ReadInputData((GPIO_TypeDef *)GPIOx);
  }
}
...
uint8_t GPIO_ReadOutputDataBit(uint32_t* GPIOx, uint16_t GPIO_Pin)
{
  if (GPIOx == (uint32_t *)GPIOA)
  {
    return GPIOA_ReadOutputDataBit((GPIOA_TypeDef *)GPIOx, GPIO_Pin);
  }
  else
  {
    return GPIOBToF_ReadOutputDataBit((GPIO_TypeDef *)GPIOx, GPIO_Pin);
  }
}
...
uint16_t GPIO_ReadOutputData(uint32_t* GPIOx)
{
  if (GPIOx == (uint32_t *)GPIOA)
  {
    return GPIOA_ReadOutputData((GPIOA_TypeDef *)GPIOx);
  }
  else
  {
    return GPIOBToF_ReadOutputData((GPIO_TypeDef *)GPIOx);
  }
}
...
/**
  ...
  * @param  GPIOx: (uint32_t*)GPIOA~GPIOF
            GPIO_Pin: can use the '|' operator
                GPIO_Pin_0 ~ GPIO_Pin_15 or GPIO_Pin_All
  * @retval None.
  */
void GPIO_SetBits(uint32_t* GPIOx, uint16_t GPIO_Pin)
{
  if (GPIOx == (uint32_t *)GPIOA)
  {
    GPIOA_SetBits((GPIOA_TypeDef *)GPIOx, GPIO_Pin);
  }
  else
  {
    GPIOBToF_SetBits((GPIO_TypeDef *)GPIOx, GPIO_Pin);
  }
}
...
void GPIO_ResetBits(uint32_t* GPIOx, uint16_t GPIO_Pin)
{
  if (GPIOx == (uint32_t *)GPIOA)
  {
    GPIOA_ResetBits((GPIOA_TypeDef *)GPIOx, GPIO_Pin);
  }
  else
  {
    GPIOBToF_ResetBits((GPIO_TypeDef *)GPIOx, GPIO_Pin);
  }
}
...
/**
  * @brief  Toggle output data register bit.
  * @param  GPIOx: GPIO 
            GPIO_Pin: can use the ��|�� operator
                GPIO_Pin_0~GPIO_Pin_15 or GPIO_Pin_All
  * @retval None.
...
/**
  ...
  * @retval None.
  */
void GPIO_WriteBit(uint32_t* GPIOx, uint16_t GPIO_Pin, uint8_t val)
{
  if (GPIOx == (uint32_t *)GPIOA)
  {
    GPIOA_WriteBit((GPIOA_TypeDef *)GPIOx, GPIO_Pin, val);
  }
  else
  {
    GPIOBToF_WriteBit((GPIO_TypeDef *)GPIOx, GPIO_Pin, val);
  }
}
...
/**
  ...
  * @retval None.
  */
void GPIO_Write(uint32_t* GPIOx, uint16_t val)
{
  if (GPIOx == (uint32_t *)GPIOA)
  {
    GPIOA_Write((GPIOA_TypeDef *)GPIOx, val);
  }
  else
  {
    GPIOBToF_Write((GPIO_TypeDef *)GPIOx, val);
  }
}
