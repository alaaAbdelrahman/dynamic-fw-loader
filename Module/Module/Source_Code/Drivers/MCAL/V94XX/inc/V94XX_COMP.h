/**
  ...
  ******************************************************************************
  */
#ifndef __V94XX_COMP_H
#define __V94XX_COMP_H
...
#define COMP_REF_LPREF            (0)
#define COMP_REF_ADCREF           ANA_REG2_REFSEL_CMP1
#define IS_COMP_REF(__REF__)  (((__REF__) == COMP_REF_LPREF)  ||\
                               ((__REF__) == COMP_REF_ADCREF))
