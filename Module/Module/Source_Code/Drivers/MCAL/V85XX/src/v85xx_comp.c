...
void COMP_DEBConfig(uint32_t COMPx, uint32_t Debounce)
{
  ...
  /* Check parameters */
  assert_param(IS_COMP(COMPx));
  assert_param(IS_COMP_DEB(Debounce));  
...
void COMP_ModeConfig(uint32_t COMPx, uint32_t Mode)
{
  ...
  /* Check parameters */
  assert_param(IS_COMP(COMPx));
  assert_param(IS_COMP_MODE(Mode));
...
void COMP_SignalSourceConfig(uint32_t COMPx, uint32_t SourceSelect)
{
  ...
  /* Check parameters */
  assert_param(IS_COMP(COMPx));
  assert_param(IS_COMP_SIGNALSRC(SourceSelect));
...
void COMP_REFConfig(uint32_t COMPx, uint32_t REFSelect)
{
  ...
  /* Check parameters */
  assert_param(IS_COMP(COMPx));
  assert_param(IS_COMP_REF(REFSelect));
...
void COMP_BiasConfig(uint32_t COMPx, uint32_t BiasSel)
{
  ...
  /* Check parameters */
  assert_param(IS_COMP(COMPx));
  assert_param(IS_COMP_BIAS(BiasSel));  
