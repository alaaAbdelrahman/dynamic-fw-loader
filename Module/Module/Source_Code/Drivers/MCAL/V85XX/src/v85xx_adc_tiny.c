...
void TADC_Init(TADCInitType* TADC_InitStruct)
{
  ...
  /* Check parameters */
  assert_param(IS_ADCTINY_SELADT(TADC_InitStruct->SignalSel));
  assert_param(IS_ADCTINY_ADTREF1(TADC_InitStruct->ADTREF1));
  assert_param(IS_ADCTINY_ADTREF2(TADC_InitStruct->ADTREF2));
  assert_param(IS_ADCTINY_ADTREF3(TADC_InitStruct->ADTREF3));
...
void TADC_IntTHConfig(uint32_t THSel)
{
  ...
  /* Check parameters */
  assert_param(IS_ADCTINY_THSEL(THSel)); 
