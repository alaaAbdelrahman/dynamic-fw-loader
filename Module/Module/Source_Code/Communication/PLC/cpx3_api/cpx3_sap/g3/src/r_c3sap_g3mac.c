...
typedef struct
{
    ...
    r_g3_hymac_callback_t cb[R_G3_CH_MAX];
#else
...
#if !defined(R_DEFINE_DISABLE_APP_HYBRID)
    g3mac_info.cb[ch] = *(r_g3_hymac_callback_t *)pcallbacks;
#else
    g3mac_info.cb[ch] = *(r_g3_mac_callback_t *)pcallbacks;
#endif
...
{
#if !defined(R_DEFINE_DISABLE_APP_HYBRID)
    R_memset(&g3mac_info.cb[ch], 0, sizeof(r_g3_hymac_callback_t));
#else
...
void R_G3MAC_BaseCb(uint8_t *pbuff)
{
    ...
    r_result_t status;
#if !defined(R_DEFINE_DISABLE_APP_HYBRID)
    r_g3_hymac_callback_t *pCb;
#else
    r_g3_mac_callback_t *pCb;
#endif
    ...
    pCb = &g3mac_info.cb[idc];

    switch (idp)
    {
    case R_G3_UNITID_G3MAC:
    {
        status = R_G3MAC_CbBin2Str(funcId, &pbuff[2], max_len, g3mac_info.pcb_str, &length);
    }
    break;
#if !defined(R_DEFINE_DISABLE_APP_HYBRID)
    ...
    {
        status = R_G3RFMAC_CbBin2Str(funcId, &pbuff[2], max_len, g3mac_info.pcb_str, &length);
    }
    break;
#endif
    default:
    ...
    if ((R_RESULT_SUCCESS == status) && (0 != length))
    {
        ...
        case R_G3_FUNCID_MLME_GET_CNF:
        {
            ...
            {
                pCb->R_G3MAC_MlmeGetCnf(&g3mac_info.pcb_str->mlme_get_cnf);
            }
        }
        break;
        case R_G3_FUNCID_MLME_SET_CNF:
        {
            ...
            {
                pCb->R_G3MAC_MlmeSetCnf(&g3mac_info.pcb_str->mlme_set_cnf);
            }
        }
        break;
        ...
        {
            if (NULL != pCb->R_G3MAC_MlmeBeaconNotifyInd)
            {
                pCb->R_G3MAC_MlmeBeaconNotifyInd(&g3mac_info.pcb_str->mlme_beacon_notify_ind);
            }
        }
        break;
        ...
        case R_G3_FUNCID_MLME_TMR_RECEIVE_IND:
        {
            ...
            {
                pCb->R_G3MAC_MlmeTmrReceiveInd(&g3mac_info.pcb_str->mlme_tmr_receve_ind);
            }
        }
        break;
        case R_G3_FUNCID_MLME_TMR_TRANSMIT_IND:
        {
            ...
            {
                pCb->R_G3MAC_MlmeTmrTransmitInd(&g3mac_info.pcb_str->mlme_tmr_transmit_ind);
            }
        }
        break;
#if !defined(R_DEFINE_DISABLE_APP_HYBRID)
        case R_G3_FUNCID_RF_MCPS_DATA_CNF:
        {
            ...
            {
                pCb->R_G3RFMAC_McpsDataCnf(&g3mac_info.pcb_str->rf_mcps_data_cnf);
            }
        }
        break;
        case R_G3_FUNCID_RF_MLME_RESET_CNF:
        {
            ...
            {
                pCb->R_G3RFMAC_MlmeResetCnf(&g3mac_info.pcb_str->rf_mlme_reset_cnf);
            }
        }
        break;
        case R_G3_FUNCID_RF_MLME_GET_CNF:
        {
            ...
            {
                pCb->R_G3RFMAC_MlmeGetCnf(&g3mac_info.pcb_str->rf_mlme_get_cnf);
            }
        }
        break;
        case R_G3_FUNCID_RF_MLME_SET_CNF:
        {
            ...
            {
                pCb->R_G3RFMAC_MlmeSetCnf(&g3mac_info.pcb_str->rf_mlme_set_cnf);
            }
        }
        break;
        case R_G3_FUNCID_RF_MLME_SCAN_CNF:
        {
            ...
            {
                pCb->R_G3RFMAC_MlmeScanCnf(&g3mac_info.pcb_str->rf_mlme_scan_cnf);
            }
        }
        break;
        case R_G3_FUNCID_RF_MLME_START_CNF:
        {
            ...
            {
                pCb->R_G3RFMAC_MlmeStartCnf(&g3mac_info.pcb_str->rf_mlme_start_cnf);
            }
        }
        break;
        case R_G3_FUNCID_RF_MCPS_DATA_IND:
        {
            ...
            {
                pCb->R_G3RFMAC_McpsDataInd(&g3mac_info.pcb_str->rf_mcps_data_ind);
            }
        }
        break;
        case R_G3_FUNCID_RF_MLME_BEACON_NOTIFY_IND:
        {
            ...
            {
                pCb->R_G3RFMAC_MlmeBeaconNotifyInd(&g3mac_info.pcb_str->rf_mlme_beacon_notify_ind);
            }
        }
        break;
        case R_G3_FUNCID_RF_MLME_COMM_STATUS_IND:
        {
            ...
            {
                pCb->R_G3RFMAC_MlmeCommStatusInd(&g3mac_info.pcb_str->rf_mlme_comm_status_ind);
            }
        }
        break;
        case R_G3_FUNCID_RF_MLME_FRAMECOUNT_IND:
        {
            ...
            {
                pCb->R_G3RFMAC_MlmeFrameCountInd(&g3mac_info.pcb_str->rf_mlme_frame_count_ind);
            }
        }
        break;
        case R_G3_FUNCID_RF_MLME_WARNING_IND:
        {
            ...
            {
                pCb->R_G3RFMAC_MlmeWarningInd(&g3mac_info.pcb_str->rf_mlme_warning_ind);
            }
        }
        break;
        ...
        case R_G3_FUNCID_RF_MCPS_LML_DATA_IND:
        {
            ...
            {
                pCb->R_RFLMAC_LmlDataInd(&g3mac_info.pcb_str->rf_lml_data_ind);
            }
        }
        break;
#endif
...
#if !defined(R_DEFINE_DISABLE_APP_HYBRID)
        g3mac_info.pcb_str = (r_g3hymac_cb_str_t *)pcb_str;
#else
