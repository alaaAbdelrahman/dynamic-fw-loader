...
#ifndef __V94XX_LOADNVR_H
#define __V94XX_LOADNVR_H
...
typedef struct
{
  ...
  float  BATCAPResult;  // BAT2 Cap division Measure Result 
} NVR_BATMEARES;

/* Power Measure Result */
typedef struct
{
  uint32_t  VDDMEAResult;  // LDO33 Measure Result
  uint32_t  DVCCMEAResult;  // LDO15 Measure Result
  uint32_t  ADCBGPMEAResult;    // ADCBGP Measure Result
...
#define NVR_3V_BAT2_RESDIV       (0x005UL)    // Power supply: 3.3V;    Channel: BAT2;        Divider modeL: Resistive
#define NVR_3V_BAT2_CAPDIV       (0x006UL)    // Power supply: 3.3V;    Channel: BAT2;        Divider modeL: Capacitive
#define IS_NVR_ADCVOL_MODE(__MODE__)  (((__MODE__) == NVR_3V_EXTERNAL_NODIV)   ||\
                                       ...
                                       ((__MODE__) == NVR_3V_BAT2_RESDIV)      ||\
                                       ((__MODE__) == NVR_3V_BAT2_CAPDIV))
...
#define NVR_VDD_MEA1                  (__IO uint32_t *)(0x40D2C)
#define NVR_ADCBGP_MEA1               (__IO uint32_t *)(0x40D30)
...
#define NVR_VDD_MEA2                  (__IO uint32_t *)(0x40D44)
#define NVR_ADCBGP_MEA2               (__IO uint32_t *)(0x40D48)
...
//uint32_t NVR_GetADCVoltageParameter(uint32_t Mode, NVR_ADCVOLPARA *Parameter); /*ADDCode_K*/  
