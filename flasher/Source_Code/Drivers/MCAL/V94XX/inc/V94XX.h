...
#include "System_V94XX.h"                      /*!< target System            */
...
/******  target specific Interrupt Numbers ********************************************************************/
  ...
  SPI_IRQn                    = 27,     /*!< SPI global Interrupt                                           */
} IRQn_Type;
...
{                           
  ...
  __IO uint32_t RESERVED5;    /*!<                                                             Address offset: 0xC8 */
...
#define SPI_BASE                     (APBPERIPH_BASE + 0x00005800)
...
#define ISO78161                     ((ISO7816_TypeDef *) ISO78160_BASE)    //ISO78161_BASE  /*edit by A_K*/
...
#define ANA_REG5_PD_VDDDET_Pos       (6U)                                   
#define ANA_REG5_PD_VDDDET_Msk       (0x1U << ANA_REG5_PD_VDDDET_Pos)       /*!< 0x00000040 */
#define ANA_REG5_PD_VDDDET           ANA_REG5_PD_VDDDET_Msk                /*!< Power down low voltage detector */ 
...
#define ANA_REG6_BAT2DISC_Pos         (7U)                                     
#define ANA_REG6_BAT2DISC_Msk         (0x1U << ANA_REG6_BAT2DISC_Pos)        /*!< 0x00000080 */
#define ANA_REG6_BAT2DISC              ANA_REG6_BAT2DISC_Msk                 /*!< Discharge the RTCBAT battery */ 
...
//#define ANA_REG8_VDDSEL_Pos          (2U)                                     
//#define ANA_REG8_VDDSEL_Msk          (0x3U << ANA_REG8_VDDSEL_Pos)          /*!< 0x0000000C */
//#define ANA_REG8_VDDSEL              ANA_REG8_VDDSEL_Msk                   /*!< Trimming of VDD */ 
...
//#define ANA_REGA_PD_RCL                ANA_REGA_PD_RCL_Msk                     /*!< PD 32K(Hz) RC module */ 
...
#define ANA_REGD_VDDTRIM_Pos         (3U)                                     
#define ANA_REGD_VDDTRIM_Msk         (0x7U << ANA_REGD_VDDTRIM_Pos)         /*!< 0x00000038 */
#define ANA_REGD_VDDTRIM             ANA_REGD_VDDTRIM_Msk                  /*!< Trimming of VDD */ 
#define ANA_REGD_VDDTRIM_0           (0x0U << ANA_REGD_VDDTRIM_Pos)
#define ANA_REGD_VDDTRIM_1           (0x1U << ANA_REGD_VDDTRIM_Pos)
#define ANA_REGD_VDDTRIM_2           (0x2U << ANA_REGD_VDDTRIM_Pos)
#define ANA_REGD_VDDTRIM_3           (0x3U << ANA_REGD_VDDTRIM_Pos)
#define ANA_REGD_VDDTRIM_4           (0x4U << ANA_REGD_VDDTRIM_Pos)
#define ANA_REGD_VDDTRIM_5           (0x5U << ANA_REGD_VDDTRIM_Pos)
#define ANA_REGD_VDDTRIM_6           (0x6U << ANA_REGD_VDDTRIM_Pos)
#define ANA_REGD_VDDTRIM_7           (0x7U << ANA_REGD_VDDTRIM_Pos)
#define ANA_REGD_LPREFTRIM_Pos         (6U)                                     
#define ANA_REGD_LPREFTRIM_Msk         (0x3U << ANA_REGD_LPREFTRIM_Pos)          /*!< 0x000000C0 */
#define ANA_REGD_LPREFTRIM              ANA_REGD_LPREFTRIM_Msk                   /*!< Trimming of LPREF, which will affect DVCC/33's output by same ratio */ 
#define ANA_REGD_LPREFTRIM_0           (0x0U << ANA_REGD_LPREFTRIM_Pos)
#define ANA_REGD_LPREFTRIM_1           (0x1U << ANA_REGD_LPREFTRIM_Pos)
#define ANA_REGD_LPREFTRIM_2           (0x2U << ANA_REGD_LPREFTRIM_Pos)
#define ANA_REGD_LPREFTRIM_3           (0x3U << ANA_REGD_LPREFTRIM_Pos)
...
#define ANA_REGF_VDDO_EN_Pos          (2U)
#define ANA_REGF_VDDO_EN_Msk          (0x1U << ANA_REGF_VDDO_EN_Pos) 
#define ANA_REGF_VDDO_EN              ANA_REGF_VDDO_EN_Msk
...
//#define ANA_COMPOUT_BAT2PDN_Pos     (5U)                                     
//#define ANA_COMPOUT_BAT2PDN_Msk     (0x1U << ANA_COMPOUT_BAT2PDN_Pos)      /*!< 0x00000020 */
//#define ANA_COMPOUT_BAT2PDN          ANA_COMPOUT_BAT2PDN_Msk               /*!< RTC power power-down status */ 
...
#define ANA_COMPOUT_AVCCLV             ANA_COMPOUT_AVCCLV_Msk                 /*!< VDD low power status */ 
...
//#define ANA_MISC_FORCEPWR2MP           ANA_MISC_FORCEPWR2MP_Msk                /*!< Force BAT2 feed into VDDIO function when doing RTC auto-calibration control */
...
#define RTC_WKUCNT_WKUCNT              RTC_WKUCNT_WKUCNT_Msk                   /*!< This register is used to control the 32K(Hz) counter wake-up function.  The wake-up period is (WKUCNT + 1)*Counter Clock */ 
...
#define RTC_CE_BSY                     RTC_CE_BSY_Msk                          /*!< This flag is used to indicated the RTC update procedure or RTC read procedure is ongoing.  This bit will be set immediately after the CE is cleared from 1 to 0 or when RTC_LOAD port is read by CPU.  This bit will cleared automatically after the read or write procedure is done.  Programmer can polling this bit to know if the RTC update is done or not.  The update or read procedure take around 3 32K(Hz) period, which is around 100 us */ 
...
#define RTC_LOAD_LOAD                  RTC_LOAD_LOAD_Msk                       /*!< This register is used to let RTC engine read data from RTC core.  When programmer read from this port, the current time will be latched and programmer can read data from RTC_SEC ~ RTC_YEAR register.  The read procedure will takes 3 32K(Hz) cycles, programmer can check the BSY bit to know if the procedure is done.  The read data from this port is invalid */ 
...
#define RTC_INTSTS_INTSTS6             RTC_INTSTS_INTSTS6_Msk                  /*!< Interrupt status 6, this interrupt will be set when 32K(Hz) counter interrupt period set by WKUCNT is reach.    Write 1 to clear this bit */ 
...
#define DMA_CTL_DMASEL_ISO7816TX      (0xEU << DMA_CTL_DMASEL_Pos)             /*!< 0x00000700 */
#define DMA_CTL_DMASEL_ISO7816RX      (0xFU << DMA_CTL_DMASEL_Pos)             /*!< 0x00000780 */
...
#define DMA_CTL_DMASEL_SPITX          (0x1EU << DMA_CTL_DMASEL_Pos)            /*!< 0x00000F00 */
#define DMA_CTL_DMASEL_SPIRX          (0x1FU << DMA_CTL_DMASEL_Pos)            /*!< 0x00000F80 */
...
#define MISC2_PCLKEN_SPI_Pos          (21U)                                     
#define MISC2_PCLKEN_SPI_Msk          (0x1U << MISC2_PCLKEN_SPI_Pos)          /*!< 0x00200000 */
#define MISC2_PCLKEN_SPI               MISC2_PCLKEN_SPI_Msk                   /*!< SPI */ 
...
#define RTC_WKUCNTR      (volatile unsigned *)(RTC_BASE + 0x00CC)
#define RTC_ACKTEMP      (volatile unsigned *)(RTC_BASE + 0x00D0)
...
/*                                                                            */
/******************************************************************************/
#define SPI_CTRL       (volatile unsigned *)(SPI_BASE + 0x0000)
#define SPI_TXSTS      (volatile unsigned *)(SPI_BASE + 0x0004)
#define SPI_TXDATA     (volatile unsigned *)(SPI_BASE + 0x0008)
#define SPI_RXSTS      (volatile unsigned *)(SPI_BASE + 0x000C)
#define SPI_RXDATA     (volatile unsigned *)(SPI_BASE + 0x0010)
#define SPI_MISC       (volatile unsigned *)(SPI_BASE + 0x0014)
...
/****************************** ISO7816 Instances *****************************/
#define IS_ISO7816_ALL_INSTANCE(INSTANCE) ((INSTANCE) == ISO7816)
