...
#define PWM_CCTL_CCIGG                 PWM_CCTL_CCIGG_Msk                      /*!< this bit will be set when a capture event is coming and the TAR will be latched into CCRx */
...
#define PWM_CCTL_CCIE                  PWM_CCTL_CCIE_Msk                       /*!< Capture/Compare interrupt enable register */
