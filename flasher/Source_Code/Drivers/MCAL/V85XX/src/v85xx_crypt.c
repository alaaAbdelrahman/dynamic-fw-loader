...
{
  /* Check parameters */
  assert_param(IS_CRYPT_ADDR(AddrA));
...
{
  /* Check parameters */
  assert_param(IS_CRYPT_ADDR(AddrB));
...
{
  /* Check parameters */
  assert_param(IS_CRYPT_ADDR(AddrO)); 
...
{
  /* Check parameters */
  assert_param(IS_CRYPT_LENGTH(Length)); 
  assert_param(IS_CRYPT_NOSTOP(Nostop));
