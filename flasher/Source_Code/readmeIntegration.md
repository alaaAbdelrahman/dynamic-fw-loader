...
│ x0003C000: Module Exec Buffer   │ ← One module loaded here
└──────────────────────────────────┘
         ↑
...
// 2. Calculate address: 0x0003C000 + 0x0048 = 0x0003C048
// 3. Set Thumb bit: 0x0003C048 | 0x01 = 0x0003C049
// 4. Return: 0x0003C049 (function pointer to Keypad_Scan)
```
...
g_loader.funcs[0] = 0x0003C000 (Keypad_Init with Thumb bit)
g_loader.funcs[1] = 0x0003C049 (Keypad_Scan with Thumb bit)
g_loader.funcs[2] = 0x0003C0B5 (Keypad_GetKey with Thumb bit)
