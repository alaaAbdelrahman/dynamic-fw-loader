...
__vector_table
        ...
        DCD     ISO7816_IRQHandler             ; ISO7816,       IRQ12
        DCD     0                              ; Reserved,      IRQ13
...
;;      3. Configure crystal drive capability(ANA_REG4 = 1)
;;      4. VLCD setting 
;;      5. SWT2VDD = 0; SWT2BAT = 0, VDD3OFF = 1
;;      6. RTC REG to default
  IF (__CHIPINITIAL != 0)
...
CONFIG5_START
        ...
        LDR     R1, =0H
        STR     R1, [R0]
        ; SWT2BAT = 0, VDD3OFF = 1, ANA_REGA[6:0] = 0x02
        LDR     R2, =02H
        LDR     R3, =7FH
        LDR     R0, =40014228H
        LDR     R1, [R0]
