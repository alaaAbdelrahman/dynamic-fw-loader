/**
  ...
  ******************************************************************************
  */
#ifndef __V94XX_ADC_H
#define __V94XX_ADC_H
...
#define ADC_3V_BAT1_RESDIV       (0x003UL)    // Power supply: 3.3V;    Channel: BAT1;        Divider modeL: Resistive
#define ADC_3V_BAT1_CAPDIV       (0x004UL)    // Power supply: 3.3V;    Channel: BAT1;        Divider modeL: Capacitive
#define ADC_3V_BAT2_RESDIV       (0x005UL)    // Power supply: 3.3V;    Channel: BAT2;      Divider modeL: Resistive
#define ADC_3V_BAT2_CAPDIV       (0x006UL)    // Power supply: 3.3V;    Channel: BAT2;      Divider modeL: Capacitive
#define IS_ADCVOL_MODE(__MODE__)      (((__MODE__) == ADC_3V_EXTERNAL_NODIV)   ||\
                                       ...
                                       ((__MODE__) == ADC_3V_BAT1_CAPDIV)       ||\
                                       ((__MODE__) == ADC_3V_BAT2_RESDIV)      ||\
                                       ((__MODE__) == ADC_3V_BAT2_CAPDIV))
...
//uint32_t ADC_CalculateVoltage(uint32_t Mode, int16_t adc_data, float *Voltage);                  /*ADDCode_K*/  
