...
{
  /* Check parameters */
  assert_param(IS_U32K_ALL_INSTANCE(U32Kx));
...
void U32K_Init(U32K_TypeDef *U32Kx, U32K_InitType *InitStruct)
{
  ...
  /* Check parameters */
  assert_param(IS_U32K_ALL_INSTANCE(U32Kx));
  assert_param(IS_U32K_DEBSEL(InitStruct->Debsel));
  assert_param(IS_U32K_PARITY(InitStruct->Parity));
  assert_param(IS_U32K_WORDLEN(InitStruct->WordLen));
  assert_param(IS_U32K_FIRSTBIT(InitStruct->FirstBit));
  assert_param(IS_U32K_AUTOCAL(InitStruct->AutoCal));
  assert_param(IS_U32K_LINE(InitStruct->LineSel));
  assert_param(IS_U32K_BAUDRATE(InitStruct->Baudrate));
...
void U32K_INTConfig(U32K_TypeDef *U32Kx, uint32_t INTMask, uint8_t NewState)
{
  ...
  /* Check parameters */
  assert_param(IS_U32K_ALL_INSTANCE(U32Kx));
  assert_param(IS_U32K_INT(INTMask));
...
uint8_t U32K_GetINTStatus(U32K_TypeDef *U32Kx, uint32_t INTMask)
{
  /* Check parameters */
  assert_param(IS_U32K_ALL_INSTANCE(U32Kx));
  assert_param(IS_U32K_INTFLAGR(INTMask));
...
void U32K_ClearINTStatus(U32K_TypeDef *U32Kx, uint32_t INTMask)
{
  /* Check parameters */
  assert_param(IS_U32K_ALL_INSTANCE(U32Kx));
  assert_param(IS_U32K_INTFLAGC(INTMask));
...
void U32K_BaudrateConfig(U32K_TypeDef *U32Kx, uint32_t BaudRate)
{
  /* Check parameters */
  assert_param(IS_U32K_ALL_INSTANCE(U32Kx));
  assert_param(IS_U32K_BAUDRATE(BaudRate));
...
void U32K_LineConfig(U32K_TypeDef *U32Kx, uint32_t Line)
{
  ...
  /* Check parameters */
  assert_param(IS_U32K_ALL_INSTANCE(U32Kx));
  assert_param(IS_U32K_LINE(Line));  
...
void U32K_WKUModeConfig(U32K_TypeDef *U32Kx, uint32_t WKUMode)
{
  ...
  /* Check parameters */
  assert_param(IS_U32K_ALL_INSTANCE(U32Kx));
  assert_param(IS_U32K_WKUMODE(WKUMode));
