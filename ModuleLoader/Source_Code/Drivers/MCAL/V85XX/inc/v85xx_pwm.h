...
//Capture mode
#define PWM_CM_DISABLE      PWM_CCTL_CM_DISABLE
#define PWM_CM_RISING       PWM_CCTL_CM_RISING
#define PWM_CM_FALLING      PWM_CCTL_CM_FALLING
#define PWM_CM_BOTH         PWM_CCTL_CM_BOTH
...
//Interrupt
#define PWM_INT_CCIFG       PWM_CCTL_CCIGG
